    ...
    var Calendar = BaseCalendar.extend({
        ...
        setup: function() {
            ...
            if (!!this.get("showTime")) {
                this.times = new TimeColumn(attrs);
            }
            var self = this;
            /*
             * showTime，则监听times
            ...
            this.dates.on("select", function(value, el) {
                ...
                if (moment.isMoment(value)) {
                    var year = value.year(), month = value.month(), date = value.date();
                    var focus = moment(self.get("focus"), self.get("format"));
                    focus.year(year).month(month).date(date);
                    self.set("focus", focus);
                }
                var focus = self.get("focus");
...
define("alinw/calendar/1.1.1/base-calendar-debug", [ "$-debug", "arale/position/1.0.1/position-debug", "gallery/moment/2.0.0/moment-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "arale/iframe-shim/1.0.2/iframe-shim-debug", "alinw/calendar/1.1.1/i18n/zh-cn-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    ...
    var lang = require("alinw/calendar/1.1.1/i18n/zh-cn-debug") || {};
...
define("alinw/calendar/1.1.1/i18n/zh-cn-debug", [], {
    Su: "日",
    Mo: "一",
    Tu: "二",
    We: "三",
...
define("alinw/calendar/1.1.1/date-column-debug", [ "$-debug", "gallery/moment/2.0.0/moment-debug", "alinw/calendar/1.1.1/base-column-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var moment = require("gallery/moment/2.0.0/moment-debug");
    var BaseColumn = require("alinw/calendar/1.1.1/base-column-debug");
...
define("alinw/calendar/1.1.1/base-column-debug", [ "$-debug", "gallery/moment/2.0.0/moment-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var moment = require("gallery/moment/2.0.0/moment-debug");
    var Widget = require("arale/widget/1.1.1/widget-debug");
    var current_date = moment();
...
define("alinw/calendar/1.1.1/month-column-debug", [ "$-debug", "gallery/moment/2.0.0/moment-debug", "alinw/calendar/1.1.1/base-column-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var moment = require("gallery/moment/2.0.0/moment-debug");
    var BaseColumn = require("alinw/calendar/1.1.1/base-column-debug");
...
define("alinw/calendar/1.1.1/year-column-debug", [ "$-debug", "alinw/calendar/1.1.1/base-column-debug", "gallery/moment/2.0.0/moment-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var BaseColumn = require("alinw/calendar/1.1.1/base-column-debug");
...
define("alinw/calendar/1.1.1/time-column-debug", [ "$-debug", "alinw/tip/2.1.0/tip-debug", "arale/tip/1.2.2/tip-debug.js", "arale/popup/1.1.6/popup-debug", "arale/overlay/1.1.4/overlay-debug", "arale/position/1.0.1/position-debug", "arale/iframe-shim/1.0.2/iframe-shim-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "alinw/calendar/1.1.1/base-column-debug", "gallery/moment/2.0.0/moment-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    ...
    var TimeColumn = BaseColumn.extend({
        ...
        select: function(value, el) {
            var role = $(el).data("role").split("-")[1], value = $(el).data("value"), focus = this.get("focus");
            if (role == "hour") {
                focus.hour(value);
            }
            if (role == "minute") {
        ...
        focus: function(focus) {
            ...
            this.element.find("[data-role=time-hour]").val(hour);
            this.element.find("[data-role=time-minute]").val(minute);
            this.element.find("[data-role=time-second]").val(second);
        },
        _sync: function(focus, el) {
            this.set("focus", focus);
            this.focus(focus);
            if (el !== null) {
                var role = $(el).data("role").split("-")[1];
            }
            return focus;
        },
        _test: function() {
    ...
    function template(model, options) {
        ...
        html += '<input type="text" data-role="time-hour" class="ui-calendar-time-input" value="' + model.hour + '" />';
        html += '<span class="ui-calendar-time-sep">:</span>';
        html += '<input type="text" data-role="time-minute" class="ui-calendar-time-input" value="' + model.minute + '" >';
        html += '<span class="ui-calendar-time-sep">:</span>';
        html += '<input type="text" data-role="time-second" class="ui-calendar-time-input" value="' + model.second + '" />';
        html += '<button data-role="time-button" class="kuma-button kuma-button-sblue">确定</button>';
        html += "</div>";
