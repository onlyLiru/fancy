define("alinw/dialog/2.0.3/confirmbox-debug", [ "$-debug", "./dialog-debug", "arale/overlay/1.1.4/overlay-debug", "arale/position/1.0.1/position-debug", "arale/iframe-shim/1.0.2/iframe-shim-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "arale/overlay/1.1.4/mask-debug", "arale/templatable/0.9.2/templatable-debug", "gallery/handlebars/1.0.2/handlebars-debug", "./dialog-debug.handlebars", "./confirmbox-debug.handlebars" ], function(require, exports, module) {
    ...
    var ConfirmBox = Dialog.extend({
        attrs: {
            title: "标题",
            confirmTpl: '<a class="kuma-button kuma-button-sblue" href="javascript:;">确&nbsp;&nbsp;定</a>',
            cancelTpl: '<a class="kuma-button kuma-button-swhite" href="javascript:;">取&nbsp;&nbsp;消</a>',
            message: "默认内容"
        },
        setup: function() {
            ...
            var model = {
                ...
                msgTileTpl: this.get("msgTileTpl"),
        ...
        _onChangeTimeout: function(val) {
            this.$("[data-role=timeout]").html(val);
        },
        _onChangeIconType: function(val) {
            this.$("[data-role=iconType]").html(val);
        },
        _onChangeMsgTile: function(val) {
            this.$("[data-role=msgTile]").html(val);
        },
    ...
    ConfirmBox.iconView = function(message, callback, options) {
        var defaults = {
            message: message,
            iconType: options.iconType,
            msgTileTpl: options.msgTile,
            title: options.title ? options.title : "",
            afterShow: function() {
                var that = this;
                //For timeout simple lite hint use.
                if (typeof options.timeout === "number" && options.timeout) {
                    var sys_second = Math.round(options.timeout / 1e3);
                    var _secView = $(".kuma-dialog-second-view");
                    _secView.html(sys_second);
                    ...
                    setTimeout(function() {
                        if ($.isFunction(callback)) {
                            if (callback.apply(that) === false) {
                                return;
                            }
                        }
                        that.hide();
                    }, options.timeout ? options.timeout : 2e3);
                }
            },
            afterRender: function() {
                //For simple lite hint use.
                if (typeof options.simple === "boolean" && options.simple) {
                    this.$("[data-role=message]").css({
                        "margin-bottom": "0"
                    });
                    this.$(".kuma-dialog-container").css({
                        "padding-bottom": "15px"
                    });
                }
            },
    ...
    // TODO should be same with confirmbox 1.0.1 nocomfirm Tips use.
    ConfirmBox.tipConfirm = function(message, callback, options) {
        var defaults = {
            message: message,
            title: ""
        };
...
define("alinw/dialog/2.0.3/dialog-debug", [ "$-debug", "arale/overlay/1.1.4/overlay-debug", "arale/position/1.0.1/position-debug", "arale/iframe-shim/1.0.2/iframe-shim-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "arale/overlay/1.1.4/mask-debug", "arale/templatable/0.9.2/templatable-debug", "gallery/handlebars/1.0.2/handlebars-debug" ], function(require, exports, module) {
    ...
    var Dialog = Overlay.extend({
        ...
        attrs: {
            // 模板
            template: require("alinw/dialog/2.0.3/dialog-debug.handlebars"),
            // 对话框触发点
            trigger: {
                value: null,
                getter: function(val) {
...
define("alinw/dialog/2.0.3/dialog-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
...
define("alinw/dialog/2.0.3/confirmbox-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
    var Handlebars = require("gallery/handlebars/1.0.2/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [ 3, ">= 1.0.0-rc.4" ];
        ...
        function program3(depth0, data) {
            ...
            buffer += escapeExpression(stack1) + '-icon-view" data-role="">\n        ';
            stack1 = helpers["if"].call(depth0, depth0.iconType, {
                hash: {},
                inverse: self.noop,
            ...
            buffer += escapeExpression(stack1) + '-tile" data-role="msgTile">\n            ';
            if (stack1 = helpers.msgTileTpl) {
                stack1 = stack1.call(depth0, {
                    hash: {},
                    data: data
                });
            } else {
                stack1 = depth0.msgTileTpl;
                stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1;
            }
            if (stack1 || stack1 === 0) {
                buffer += stack1;
        ...
        function program4(depth0, data) {
            var buffer = "", stack1;
            buffer += ' \n            <i class="kuma-icon kuma-icon-';
            if (stack1 = helpers.iconType) {
                stack1 = stack1.call(depth0, {
                    hash: {},
                    data: data
                });
            } else {
                stack1 = depth0.iconType;
                stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1;
            }
        ...
        function program8(depth0, data) {
            ...
            buffer += escapeExpression(stack1) + "-operation ";
            stack1 = helpers["if"].call(depth0, depth0.iconType, {
                hash: {},
                inverse: self.noop,
            ...
            buffer += "\n        ";
            stack1 = helpers["if"].call(depth0, depth0.autoHide, {
                hash: {},
                inverse: self.noop,
        ...
        function program13(depth0, data) {
            ...
            buffer += escapeExpression(stack1) + '-auto-close">\n            <span class="';
            if (stack1 = helpers.classPrefix) {
                stack1 = stack1.call(depth0, {
                    hash: {},
                    data: data
            ...
            buffer += escapeExpression(stack1) + '-second-view"></span>秒后将自动关闭.\n        </div>\n        ';
            return buffer;
        }
        ...
        stack1 = helpers["if"].call(depth0, depth0.msgTileTpl, {
            hash: {},
            inverse: self.noop,
