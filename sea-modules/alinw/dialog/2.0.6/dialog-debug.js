    ...
    var Dialog = Overlay.extend({
        ...
        _setupMask: function() {
            ...
            this.after("show", function() {
                ...
                mask.set("opacity", .5).set("backgroundColor", "#000").set("zIndex", that.get("zIndex")).show();
