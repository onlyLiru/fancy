define("/WEB-UED/fancy/dist/p/myWallets/index-debug", ["/WEB-UED/fancy/dist/c/js/globale-debug"], function(require, exports, module) {
                ...
                success: function(res) {
                    ...
                    if (res.info.ok == true) {
                        if (res.data.redPacket && res.data.redPacket.balance && res.data.redPacket.balance > 0) {
                            $("#J-red-packet").html('<i class="iconfont pointer fz20">&#xe680;</i>                            <p>' + res.data.redPacket.balance + "</p>")
                        } else {
